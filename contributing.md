...
---
# 向Adobe Experience Manager文档投稿

感谢您选择向Adobe Experience Manager Cloud Service文档投稿！ Adobe欢迎整个读者社区以及Adobe员工贡献内容。
...
虽然Adobe欢迎任何有助于改进AEM文档的投稿，但请确保投稿尽可能遵守某些准则和标准。 有关详细信息，请参阅[AEM文档内容贡献准则](guidelines.md)。
...
通过创建问题，您可以轻松描述自己关于如何改进文档的想法，以供AEM文档团队成员查阅。 单击任意页面右侧导航面板顶部的&#x200B;**记录问题**&#x200B;以创建问题。

### 创建拉取请求 {#create-a-pull-request}

如果您发现了问题并且确切知道如何解决该问题，请考虑创建拉取请求。 拉取请求允许您对文档进行自己的编辑。 AEM文档团队成员会审查编辑内容以将其包含。 单击任意页面右侧导航面板顶部的&#x200B;**编辑此页面**&#x200B;以进行建议的更改并创建拉取请求。

所有拉取请求都必须具有已签署的[参与者许可协议或CLA](https://opensource.adobe.com/cla.html)。 CLA会授予Adobe在项目中再次分发您贡献内容的权限。 您只需提交一次Adobe CLA即可，因此，如果您以前已经提交过，则无需重新提交！
...
Adobe很乐意收到任何内容贡献，如果您是通过公共存储库贡献内容的，我们将会审核您的贡献。 但是，来自Adobe员工的拉取请求更易于处理，并且可以在公司存储库中更快地获得批准。 确保仅在公司存储库中讨论任何专有信息。
