...
[在 AEM 6.0 中引入的HTML 模板语言](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-htl/content/history)，是 AEM 中适用于 HTML 的首选和推荐的服务器端模板系统。 对于需要构建强大企业网站的 Web 开发者来说，HTML 模板语言有助于提高安全性和开发效率。
...
请注意，视频中是以[其原名 Sightly 指代 HTL](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-htl/content/history)。
...
现在您已经了解了 HTL 的目标和优势，您可以开始使用该语言。请参见[HTML 模板语言快速入门](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-htl/content/getting-started)。
