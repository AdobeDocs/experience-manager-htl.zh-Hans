...
1. **[AEM扩展](https://experienceleague.adobe.com/en/docs/experience-manager-htl/content/aem-extensions)** - AEM构建在`Sling` HTL脚本引擎之上，以便为开发人员提供AEM特有的方便功能。 这些扩展作为本文档集的一部分进行记录。
