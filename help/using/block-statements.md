...
>[!NOTE]
>
>AEM 可提供清晰而简单的逻辑来控制用于封装所包含元素的修饰标记。有关详细信息，请参阅开发组件文档中的[修饰标记](https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/developing/components/decoration-tag.html)。
